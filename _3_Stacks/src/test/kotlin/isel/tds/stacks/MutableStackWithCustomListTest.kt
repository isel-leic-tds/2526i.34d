...
class MutableStackWithCustomListTest {
    @Test
    fun `test empty stack`(){
        var stack = MutableStackWithCustomList<Char>()
    ...
    fun testEqualityOfStacks(){
        val sut = MutableStackWithCustomList<Char>()
        sut.push('A')
        sut.push('B')
        val sut2 = MutableStackWithCustomList<Char>()
        sut2.push('A')
        sut2.push('B')
